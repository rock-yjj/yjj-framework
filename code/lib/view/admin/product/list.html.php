...
<div class="container_12">
            <div class="grid_12">
                    ...
                    <a href="<?php echo $this->_context->url('', array('module' => 'admin', 'controller' => 'product', 'action' => 'add')); ?>" class="button">
                            <span>添加产品<img width="12" height="9" src="/admin/images/plus-small.gif" alt="New Product"></span>
                        </a>
                    </div>
                </div>
...
foreach ($article as $v) {
    ...
    $update   = $this->_context->url('', array('module' => 'admin', 'controller' => 'product', 'action' => 'update', 'sn' => $v['sn']));
    $delete   = $this->_context->url('', array('module' => 'admin', 'controller' => 'product', 'action' => 'del', 'sn' => $v['sn']));
    echo <<< EOF
        <tr class="{$line}">
