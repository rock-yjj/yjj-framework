...
<div class="container_12">
            <div class="grid_12">
                    ...
                    <a href="<?php echo $this->_context->url('', array('module' => 'admin', 'controller' => 'about', 'action' => 'add')); ?>" class="button">
                            <span>添加单页<img width="12" height="9" src="/admin/images/plus-small.gif" alt="New About"></span>
                        </a>
                    </div>
                </div>
                ...
                <div class="module">
                    <h2><span>单页查询</span></h2>
                    <div class="module-body">
                            <form action="" autocomplete="off">
                            <input name="module" type="hidden" value="admin" />
                            <input name="controller" type="hidden" value="about" />
...
foreach ($article as $v) {
    ...
    $update   = $this->_context->url('', array('module' => 'admin', 'controller' => 'about', 'action' => 'update', 'sn' => $v['sn']));
    $delete   = $this->_context->url('', array('module' => 'admin', 'controller' => 'about', 'action' => 'del', 'sn' => $v['sn']));
    echo <<< EOF
        <tr class="{$line}">
