...
<div class="container_12">
            <div class="grid_12">
                ...
                <?php echo empty($flashmessage) ? '' : '<div style="text-align:center;"><font color="red">' . $flashmessage . '</font></div>'; ?>
                    ...
                    <a href="<?php echo $this->_context->url('', array('module' => 'admin', 'controller' => 'site', 'action' => 'addm')); ?>" class="button">
                        	  <span>添加分组<img width="12" height="9" src="/admin/images/plus-small.gif" alt="New Module"></span>
                        </a>
                    </div>
                </div>
                <div class="module">
                <h2><span>分组列表</span></h2>
                    <div class="module-table-body">
                        <table id="myTable" class="tablesorter">
                        	<thead>
                            <tr>
                                 <th class="header" width="5%">ID</th>
                                 <th class="header">组名</th>
                                 <th class="header">排序</th>
                                 <th class="header">其它地址</th>
...
foreach ($module as $v) {
    $line = ($i % 2) ? 'odd' : 'even';
    $update   = $this->_context->url('', array('module' => 'admin', 'controller' => 'site', 'action' => 'updatem', 'sn' => $v['sn']));
    $delete   = $this->_context->url('', array('module' => 'admin', 'controller' => 'site', 'action' => 'delm', 'sn' => $v['sn']));
    echo <<< EOF
        <tr class="{$line}">
