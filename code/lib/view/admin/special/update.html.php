...
<?php 
if ($img_url = $this->_context->imageIsExist(ROOT_DIR . '/public/upload/special', $article['sn'])) {
    echo '<img src="/upload/special/thumb_' . $img_url . '" width="118" height="84"/>';
}
                ?>
            </p>
            <p>
