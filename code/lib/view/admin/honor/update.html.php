...
window.addEvent('domready', function() {
    var editor = CKEDITOR.replace('editor1',{
        ...
        filebrowserUploadUrl : '/index.php?module=admin&controller=honor&action=upload',
        filebrowserImageUploadUrl : '/index.php?module=admin&controller=honor&action=upload&type=Images'
    });
});
//]]>
</script>
...
?>
            ...
            <p>
                ...
                <?php 
if ($img_url = $this->_context->imageIsExist(ROOT_DIR . '/public/upload/honor', $article['sn'])) {
    echo '<img src="/upload/honor/thumb_' . $img_url . '" width="118" height="84"/>';
}
                ?>
            </p>
            <p>
