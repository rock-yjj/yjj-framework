...
<div style="width:990px;border:5px solid #58A0F0;overflow-y:auto;height:500px;margin:0 auto;background-color:#ffffff;">
...
document.getElementById('button').onclick = function () {
    window.location = '/index.php?module=install&controller=index&action=check';
}
//]]>
</script>
</body>
